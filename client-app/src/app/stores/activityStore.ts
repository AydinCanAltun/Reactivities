...
export default class ActivityStore {
    ...
    @action attendActivity = async () => {
        ...
        try {
            ...
            runInAction('atten activity error', () => {
                this.loading = false;
            });
    ...
    @action cancelAttendance = async () => {
        ...
        try{
            ...
            runInAction('cancelAttendance activity', () => {
                if (this.activity) {
            ...
            runInAction('cancelAttendance activity error', () => {
                this.loading = false;
            });
            toast.error("Problem cancel attendance to Activity");
        }
